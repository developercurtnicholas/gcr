...
public class RecordingOptionsDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        date.setText(dateFormat.format(Long.parseLong(dialogdate)));
    ...
    public void registerGridListeners(GridView options){
        options.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position == 2){
                    //Save
                    MainActivity.saveRoutine(dialogPath, getContext());
                    getActivity().finish();
                ...
                if(position == 3){
                    ...
                    Intent intent = MainActivity.Share(type,dialogPath);
