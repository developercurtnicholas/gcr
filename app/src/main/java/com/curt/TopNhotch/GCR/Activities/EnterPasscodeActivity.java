...
import com.curt.TopNhotch.GCR.Adapters.PassGridOptionsAdapter;
                ...
                switch (position) {
                    ...
                    case 11: {
                        ...
                        if(passCodeString.equals(passcode)){
                            ...
                            intent.putExtra(GcrConstants.PASSWORD_EXTRA_KEY,true);
                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent);
                            finish();
                        }else{

                            Animation.fade(lockImage,0f,1f);
                        }
                        break;
                    }
                }
